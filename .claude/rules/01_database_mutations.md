...
`schema_v2.sql` or the live DB. Real routing-feedback data
lives in `routing_feedback` instead.

`gemini_audits` was orphaned (0 rows, zero Python writers) and has
been **removed** (schema_v2.sql + live DB): the whole
