...
Mecanismo: tool_name + tool_input → alias → carga 1-3 archivos de .claude/rules_db/ (~946–7751 tokens, cl100k_base real, re-medido 2026-08-18; techo = máximo realmente alcanzable, no el peor caso de la matriz).
